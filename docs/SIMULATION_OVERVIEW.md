...
- **Biodiversité** — un indice composite de **4 facteurs** (habitat = haies + prairie ; eau = profondeur de nappe ; intrants = pression chimique inversée ; paysage = diversité de la mosaïque culture/prairie + maillage de haies), plus deux modulateurs faibles (pénalité canicule, bonus sol vivant). C'est lui qui décide quels oiseaux apparaissent à l'écran.
