...
{
    /// <summary>
    /// Couche 2 history container for the camera trap
    /// (<c>sensor_camera_trap_01</c>). One of the two channels owned by
    ...
    /// (chantier E6 / ADR #53) plots the rolling 365-day series and lets
    /// the user see how the camera and acoustic channels are fused by
    /// the parent reader.
    /// </summary>
    public sealed class CameraTrapSensorReader : ISensorHistory<SensorSample<double>>
    {
